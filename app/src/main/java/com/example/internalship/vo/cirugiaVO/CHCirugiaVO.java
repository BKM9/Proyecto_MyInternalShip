...
public class CHCirugiaVO implements Parcelable {
    private int id;
    private String cama;
    private String dia;
    ...
    public CHCirugiaVO(int id,String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.id = id;
        this.cama = cama;
        this.dia = dia;
    ...
    protected CHCirugiaVO(Parcel in) {
        id = in.readInt();
        cama = in.readString();
        dia = in.readString();
    ...
    public static final Creator<CHCirugiaVO> CREATOR = new Creator<CHCirugiaVO>() {
        @Override
        public CHCirugiaVO createFromParcel(Parcel in) {
            return new CHCirugiaVO(in);
        }

        @Override
        public CHCirugiaVO[] newArray(int size) {
            return new CHCirugiaVO[size];
        }
    };
