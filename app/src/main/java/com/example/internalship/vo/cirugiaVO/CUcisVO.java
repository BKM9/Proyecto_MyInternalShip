...
public class CUcisVO implements Parcelable {
    private int id;
    private String cama;
    private String dia;
    ...
    public CUcisVO(String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso, int id) {
        this.id = id;
        this.cama = cama;
        this.dia = dia;
    ...
    public static final Creator<CUcisVO> CREATOR = new Creator<CUcisVO>() {
        @Override
        public CUcisVO createFromParcel(Parcel in) {
            return new CUcisVO(in);
        }

        @Override
        public CUcisVO[] newArray(int size) {
            return new CUcisVO[size];
        }
    };
