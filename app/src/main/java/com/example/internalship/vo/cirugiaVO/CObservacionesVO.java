...
public class CObservacionesVO implements Parcelable {
    private int id;
    private String cama;
    private String dia;
    ...
    public CObservacionesVO(int id,String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.id = id;
        this.cama = cama;
        this.dia = dia;
    ...
    public CObservacionesVO() {
    }

    protected CObservacionesVO(Parcel in) {
        id = in.readInt();
        cama = in.readString();
        dia = in.readString();
    ...
    public static final Creator<CObservacionesVO> CREATOR = new Creator<CObservacionesVO>() {
        @Override
        public CObservacionesVO createFromParcel(Parcel in) {
            return new CObservacionesVO(in);
        }

        @Override
        public CObservacionesVO[] newArray(int size) {
            return new CObservacionesVO[size];
        }
    };
