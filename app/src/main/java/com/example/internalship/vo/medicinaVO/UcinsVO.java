...
public class UcinsVO implements Parcelable {
    private String cama;
    private String dia;
    ...
    public UcinsVO(String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.cama = cama;
        this.dia = dia;
    ...
    public static final Creator<UcinsVO> CREATOR = new Creator<UcinsVO>() {
        @Override
        public UcinsVO createFromParcel(Parcel in) {
            return new UcinsVO(in);
        }

        @Override
        public UcinsVO[] newArray(int size) {
            return new UcinsVO[size];
        }
    };
