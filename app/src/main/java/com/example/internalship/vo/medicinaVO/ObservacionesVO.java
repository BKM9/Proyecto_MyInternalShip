...
public class ObservacionesVO implements Parcelable {
    private String cama;
    private String dia;
    ...
    public ObservacionesVO(String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.cama = cama;
        this.dia = dia;
    ...
    public ObservacionesVO() {
    }

    protected ObservacionesVO(Parcel in) {
        cama = in.readString();
        dia = in.readString();
    ...
    public static final Creator<ObservacionesVO> CREATOR = new Creator<ObservacionesVO>() {
        @Override
        public ObservacionesVO createFromParcel(Parcel in) {
            return new ObservacionesVO(in);
        }

        @Override
        public ObservacionesVO[] newArray(int size) {
            return new ObservacionesVO[size];
        }
    };
