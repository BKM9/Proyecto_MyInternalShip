package com.example.internalship.vo;

import android.os.Parcel;
import android.os.Parcelable;

public class ObjetoVO implements Parcelable {
    private int id;
    private String cama;
    private String dia;
    ...
    public ObjetoVO(int id, String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.id = id;
        this.cama = cama;
        this.dia = dia;
    ...
    public ObjetoVO( String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.id = id;
        this.cama = cama;
        this.dia = dia;
        this.efisico = efisico;
    ...
    public static final Creator<ObjetoVO> CREATOR = new Creator<ObjetoVO>() {
        @Override
        public ObjetoVO createFromParcel(Parcel in) {
            return new ObjetoVO(in);
        }

        @Override
        public ObjetoVO[] newArray(int size) {
            return new ObjetoVO[size];
        }
    };
