...
public class UtsVO implements Parcelable {
    ...
    public UtsVO(String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.cama = cama;
        this.dia = dia;
    ...
    public static final Creator<UtsVO> CREATOR = new Creator<UtsVO>() {
        @Override
        public UtsVO createFromParcel(Parcel in) {
            return new UtsVO(in);
        }

        @Override
        public UtsVO[] newArray(int size) {
            return new UtsVO[size];
        }
    };
