...
public class HmedicinaVO implements Parcelable {
    private String cama;
    private String dia;
    ...
    public HmedicinaVO(String cama, String dia, String efisico, String evolucion, String dx, String plan, String tratamiento, String resLab, String resImagen, String procedimiento, String horaingreso, String primeringreso) {
        this.cama = cama;
        this.dia = dia;
    ...
    protected HmedicinaVO(Parcel in) {
        cama = in.readString();
        dia = in.readString();
    ...
    public static final Creator<HmedicinaVO> CREATOR = new Creator<HmedicinaVO>() {
        @Override
        public HmedicinaVO createFromParcel(Parcel in) {
            return new HmedicinaVO(in);
        }

        @Override
        public HmedicinaVO[] newArray(int size) {
            return new HmedicinaVO[size];
        }
    };
