...
import static com.example.internalship.utils.Constantes.AMARILLO_CLARO;
...
public class Cirugia_TSHOCK extends AppCompatActivity {
    ...
    Funcionalidad_Cirugia funcionalidad_cirugia = new Funcionalidad_Cirugia(Cirugia_TSHOCK.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cirugia_tshock);
    ...
    private void init() {
        textfecha = findViewById(R.id.ET_FECHA_TSHOCK_CIRUGIA);
        txthoraingrreso = findViewById(R.id.ET_HORA_TSHOCK_CIRUGIA);
        twnumdias = findViewById(R.id.ET_DIAS_TSHOCK_CIRUGIA);
        switchModificar = findViewById(R.id.SWITCH_CAMPOS_TSHOCK_CIRUGIA);
        btnadd = this.findViewById(R.id.BT_AGREGAR_TSHOCK_CIRUGIA);
        ...
        btnadd.setOnClickListener(v -> {
            Intent intent = new Intent(Cirugia_TSHOCK.this, Cirugia_TSHOCK_Add.class);
    ...
    private void ocultarItems() {
        ...
        LinearLayout linearLayout = findViewById(R.id.LY_DATA_TSHOCK_CIRUGIA);
    ...
    private void cargarRowservaciones() {
        ...
        for (int x = 0; x < list.size(); x++) {
            ...
            textView.setBackgroundColor(Color.parseColor(AMARILLO_OSCURO)); // fondo personalizado
            ...
            txfisico.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            twEvolucion.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            twdx.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            twplan.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            lbTratamiento.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            lbResLab.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            lbresimagen.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
            ...
            twprocedimiento.setBackgroundColor(Color.parseColor(AMARILLO_CLARO)); // fondo personalizado
    ...
    private void mostrarOpciones(int indice) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Cirugia_TSHOCK.this);
        ...
        builder.setItems(opciones, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int seleccion) {
                if (opciones[seleccion] == NOMBRE_OPC_ELIMINAR) {
                    ...
                    Toast.makeText(Cirugia_TSHOCK.this, ALETAR_OPERACION_CANCELADA, Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
            }
        });
    ...
    private void eliminar(int indice){
        Alertas.showConfirmationDialog(Cirugia_TSHOCK.this, CONSULTA_OPCION_CONFIRMACION, CONFIRMACION_ELIMINAR, new Alertas.ConfirmationListener() {
            @Override
            public void onConfirmed() {
                float code = funcionalidad_cirugia.eliminar_Cirugia_TIPO(String.valueOf(list.get(indice).getId()),OPC_TABLA_TSHOCK);
                if (code >= 0) {
                    Toast.makeText(Cirugia_TSHOCK.this, "Eliminado correctamente", Toast.LENGTH_SHORT).show();
                    list.remove(indice);
                    Intent intent = new Intent(Cirugia_TSHOCK.this, Cirugia_TSHOCK.class);
                    intent.putExtra("idPac", idPac);
                    intent.putExtra("idCama", idCama);
                    startActivity(intent);
                    finish();
    ...
    private void update(int indice){
        ...
        int code = funcionalidad_cirugia.actualizar_Paciente_Cirugia(objeto,OPC_TABLA_TSHOCK);

        if(code >= 0){
            Toast.makeText(Cirugia_TSHOCK.this, "Se actualizo ".concat(objeto.getDia()), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Cirugia_TSHOCK.this, Cirugia_Detalle.class);
        intent.putExtra("idPac", idPac);
        intent.putExtra("idCama", idCama);
        startActivity(intent);
        finish();
