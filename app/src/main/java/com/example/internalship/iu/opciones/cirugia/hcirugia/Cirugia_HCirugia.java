...
public class Cirugia_HCirugia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cirugia_hcirugia);
    ...
    private void init() {
        textfecha = findViewById(R.id.ET_FECHA_HCIRUGIA_CIRUGIA);
    ...
    private void cargarRowservaciones() {
        ...
        for (int x = 0; x < list.size(); x++) {
            ...
            txfisico.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            twEvolucion.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            twdx.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            twplan.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            lbTratamiento.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            lbResLab.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            lbresimagen.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
            ...
            twprocedimiento.setBackgroundColor(Color.parseColor(CELESTE_CLARO)); // fondo personalizado
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Cirugia_HCirugia.this, Cirugia_Detalle.class);
        intent.putExtra("idPac", idPac);
        intent.putExtra("idCama", idCama);
        startActivity(intent);
        finish();
